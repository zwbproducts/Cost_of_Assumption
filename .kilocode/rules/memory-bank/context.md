...
| 2026-08-26 | Replaced slot table + prose with graphical `SlotCanvas` 9-tile grid (colour-coded, hover glow/scale, boundary-violation dots, legend) + animated risk-map markers; trimmed prose to short captions |
