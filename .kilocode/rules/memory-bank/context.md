...
| 2026-08-26 | Graphical interactive risk map: 3×3 heat matrix (cells tinted per severity, empty cells marked), clickable markers with embedded `HeatRing` score + L/I tags, hover scale + glow ring driven by severity, axis legend, click-to-drill detail panel, keyboard activation |
